...
<section class="py-20 text-white bg-black">
	<div class="flex flex-col space-y-20 max-w-screen-lg mx-auto">
		<div class="flex flex-col justify-center">
			<h2 class="text-4xl font-bold font-heading text-center">We help you grow</h2>
		</div>
		<div class="flex space-x-24">
			<div class="flex flex-col w-1/2 space-y-6 justify-center">
				<h5 class="font-semibold text-2xl">Monetize your way</h5>
				<p>
